    ...
    <div className="grid py-6">
      ...
      <div className=" bg-white p-2 rounded-md">
        ...
        <ul className="list-disc">
            <li className=" text-zinc-600 ml-12 py-2 font-bold">Fleeting notes</li>
                <p className=" text-zinc-600 text-sm pl-16">Quick and temporary notes to capture thoughts and snippets of information.</p>
            <li className=" text-zinc-600 ml-12 py-2 font-bold">Permanent notes</li>
            ...
            <li className=" text-zinc-600 ml-12 py-2 font-bold">Literature notes</li>
                <p className=" text-zinc-600 text-sm pl-16">Notes created to capture key insights and reflections of books and articles.</p>
            <li className=" text-zinc-600 ml-12 py-2 font-bold">Reference notes</li>
