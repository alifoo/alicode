...
export default function RootLayout({
  ...
  const header = (
    <header>
      <div className="flex group items-center bg-zinc-800 dark:bg-zinc-900 rounded-md shadow-lg px-3 py-2 mt-2 ring-offset-2 ring-zinc-600 ring-2 transition duration-500 delay-300 ease-in-out h-20 md:h-10 dark:ring-zinc-600 hover:dark:ring-violet-500 hover:ring-4 dark:ring-offset-neutral-800">
        <Link href="/">
        ...
        <h1 className="text-white items-center font-bold inline-block text-left ml-1 transition-width duration-200 delay-200 ease-in-out w-0 group-hover:w-4 truncate group-hover:whitespace-normal dark:text-zinc-200">=</h1>
        <p className="text-zinc-300 flex items-center text-sm transition-width max-h-4 duration-300 delay-300 ease-in-out w-0 group-hover:w-96 truncate group-hover:text-clip dark:text-zinc-200">
  ...
  return (
    <html lang="en">
      <head />
      <body className={`${space_mono.className} dark:bg-neutral-900`}>
